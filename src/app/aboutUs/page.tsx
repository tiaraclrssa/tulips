  ...
  useEffect(() => {
    ...
    return(
        <div className="bg-gray-300">
            <div className="bg-gray-600 mt-[92px] flex flex-row">
            <Image
            ...
            />
            <div ref={textRef}
            className={`flex flex-col text-white mt-10 px-40 mb-5 transition-all duration-1000 ${
            ...
            <div className="bg-gray-600 flex flex-row mt-20 items-center ">
            <p className=" text-white text-md px-28">
            ...
            <span className="font-bold text-gray-950"> Pada tahun 2018</span>, Tulip Flowers resmi berdiri sebagai sebuah perusahaan  
            yang bergerak di bidang industri florist bukan lagi sekedar toko bunga biasa. 
            di tahun ini pula kami meluncurkan platform e-commerce Tulip Flowers,  
            ...
            <div className="flex flex-row mt-20 bg-gray-600 items-center">
            <Image
